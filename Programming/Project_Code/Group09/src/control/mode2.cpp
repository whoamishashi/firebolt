...
//get all data needed for next control
		...
		case ATTITUDE_CONTROL_MODE_AUTO:
			...
			/////////////////
			//if closer then 15cm away from other vehicle -> initialize docking
			/////////////////
...
//			PRINTF("before");
			...
			///////////////////////////////////////////////////////////////////////////
			// START OF ANGUAR VELOCITY CONTROL
			///////////////////////////////////////////////////////////////////////////
...
//			PRINTF("\nIR_RANGE2: %d", iRData.range2);
			...
			Servo.write(1900);
//everything is done in RaspberryPi and send via buffer, plus code from Martin for Objectrecognition is
//			not designed for objects that are not directly in sight of view -> angular rotation not needed (is commented)
//			setpoint_av = 2;			//desired rotational speed in [deg/sec]
			break;
		...
		// set the controlled Values and publish them
...
void Mode2::anglePositionRedefinition_Mode0() {
	if ((set_pointPos[0] - currentPos[0]) == 0) {
		theta_set_point = 88;
	} else {
